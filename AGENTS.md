...
- Only change formatting through biome --write commands
- Fix lint fixable lint issues with biome lint --write too.
- Do not manually edit generated files, lockfiles. Always update the source (openapi, etc) and run generate.
...
- Always use caveman
- Always execute these commands outside sandbox: `pnpm`, `git` write commands, `gh`
